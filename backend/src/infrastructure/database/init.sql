...
-- =====================================================
-- benchmarks: 市場ベンチマーク（Market Context）
...
COMMENT ON COLUMN benchmarks.symbol IS '指数シンボル（^GSPC: S&P500, ^NDX: NASDAQ100）';
COMMENT ON COLUMN benchmarks.date IS '記録日';
COMMENT ON COLUMN benchmarks.performance_1y IS '1年パフォーマンス（%）';
COMMENT ON COLUMN benchmarks.performance_9m IS '9ヶ月パフォーマンス（%）';
COMMENT ON COLUMN benchmarks.performance_6m IS '6ヶ月パフォーマンス（%）';
COMMENT ON COLUMN benchmarks.performance_3m IS '3ヶ月パフォーマンス（%）';
COMMENT ON COLUMN benchmarks.performance_1m IS '1ヶ月パフォーマンス（%）';
COMMENT ON COLUMN benchmarks.weighted_performance IS 'IBD式加重パフォーマンス（3M×40% + 6M×20% + 9M×20% + 12M×20%）';
COMMENT ON COLUMN benchmarks.recorded_at IS '記録日時';
